...
outputLocation2 = "output/NDVI5.tif"

#geopy.norm_dif(cloud=False, save_location=outputLocation1,shp_location=shpLocation, band1= geopy.b4, band2=geopy.b5, visualise=True)
...
geopy.NDVI(cloud=True, save_location=outputLocation2,bbcoord=bbox, visualise=False)
